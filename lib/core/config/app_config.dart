class AppConfig {
  static const String supabaseUrl = 'https://ocoegfgritkmtvbzjpbj.supabase.co';
  static const String supabaseAnonKey =
      'sb_publishable_QiTO3OZ7nFjD54ZwCy_XQg_ouGPa_Zv';

  static const String appName = 'نظام الحضور';
